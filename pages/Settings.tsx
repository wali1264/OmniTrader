...
import { User, FileImage, Database, Save, Upload, Download, CheckCircle, AlertCircle, Loader2, Move, RotateCw, Type, Trash, Grid, Monitor, Printer } from 'lucide-react';
...
const Settings: React.FC = () => {
  ...
  return (
    <div className="space-y-8 animate-fade-in pb-20" onMouseMove={handleMouseMove} onMouseUp={handleMouseUp}>
