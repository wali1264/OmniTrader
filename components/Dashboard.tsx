...
import { TrendingUp, Wallet, ArrowUpRight, ArrowDownLeft, Landmark, DollarSign, Coins, RefreshCw, Sparkles, Loader2, AlertTriangle } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 fade-entry">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        ...
        <StatCard title="صندوق دالر" value={(stats.cashBox['USD'] || 0).toLocaleString()} unit="USD" icon={<DollarSign size={14} className="text-slate-400" />} />
        ...
        <StatCard title="کلدار نقد" value={(stats.cashBox['PKR'] || 0).toLocaleString()} unit="PKR" icon={<Coins size={14} className="text-slate-400" />} />
        <StatCard title="مجموع سود خالص" value={stats.totalProfit.toLocaleString()} unit="AFN" icon={<TrendingUp size={14} className="text-white" />} highlight />
      </section>
